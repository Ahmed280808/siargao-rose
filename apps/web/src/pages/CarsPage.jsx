...
<<<<<<< HEAD
      try {
        ...
        const items = res.products.filter(p => p.title?.toLowerCase().includes('car') || p.subtitle?.toLowerCase().includes('car'));
        setVehicles(items);
...
<<<<<<< HEAD
<<<<<<< HEAD
        <title>Cars for Rent — Siargao Rose Rentals</title>
        <meta name="description" content="Rent cars on Siargao Island. Best prices, near the airport. Book online and save 5%." />
      </Helmet>
      <Header />
      <main className="min-h-screen bg-white">
        ...
        <section className="py-12">
          <div className="max-w-7xl mx-auto px-5 lg:px-10">
=======
        <title>Car Rentals in Siargao - Siargao Rose</title>
        <meta
          name="description"
          content="Rent cars in Siargao Island. Daily, weekly, and monthly rates available with online booking discounts. Browse our selection now!"
        />
=======
        <title>Cars — Siargao Rose</title>
        <meta name="description" content="Premium cars for rent on Siargao Island. Daily, weekly and monthly rates available." />
>>>>>>> 30692b7 (premium redesign with real photos and reviews)
=======
        <title>Cars for Rent — Siargao Rose Rentals</title>
        <meta name="description" content="Rent cars on Siargao Island. Best prices, near the airport. Book online and save 5%." />
...
<<<<<<< HEAD
                  <div className="text-center py-20">
                    <p className="font-condensed text-lg font-700 uppercase text-gray-400">No cars found matching your filters.</p>
=======
...
=======
                  <div className="text-center py-20">
<<<<<<< HEAD
                    <p className="text-sm font-light text-[#1a2e1a]/40">No cars found matching your filters.</p>
>>>>>>> 30692b7 (premium redesign with real photos and reviews)
=======
                    <p className="font-condensed text-lg font-700 uppercase text-gray-400">No cars found matching your filters.</p>
>>>>>>> 7a4c2f5 (bold urban redesign)
