...
function ProductDetailPage() {
    ...
    return (
      <>
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <Link to="/bikes" className="inline-flex items-center gap-2 text-muted-foreground hover:text-primary transition-colors mb-6">
            <ArrowLeft size={16} />
            Back to vehicles
          </Link>
          <div className="text-center text-destructive p-8 border rounded-2xl">
  ...
  return (
    <>
      <Helmet>
        <title>{product.title} - Siargao Rose</title>
